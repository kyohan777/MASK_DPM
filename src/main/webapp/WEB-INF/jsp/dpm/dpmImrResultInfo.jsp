    ...
    <div id="layer" class="pop-layer">
        <div class="pop-container">
            <div class="pop-conts">
                ...
                <form id="frmUserInfo" role="form"  method="post">
              	...
              	<div class="join_form">
            		...
            		<table>
             			...
             			<tbody>
                		<tr>
                  			<th><span>조회 사유</span></th>
                  			<td>
                  			<textarea id="NewRgReason" name="rgReason" rows="8" cols="45"></textarea>
							</td>
                		</tr>
              			</tbody>
            		</table>
                ...
                <div class="btn-r">
                 	<a href="#" class="btn-layerClose" id="insert">저장</a>
...
<!--//----------------- layerPopup------------------>
    ...
    <script type="text/javascript" src="/js/dpm/dpmImrResultInfo.js"></script>
</body>
</html>